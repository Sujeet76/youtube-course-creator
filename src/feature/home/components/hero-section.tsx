...
//       <div className="container mx-auto h-[calc(100dvh-var(--header))] w-full overflow-hidden px-6 pt-12 sm:overflow-visible sm:pt-16 md:px-8 lg:px-10">
...
//                   <div className="rotating-border relative size-full overflow-hidden rounded-full border border-x-2 border-primary/5 border-x-primary/10 p-[12.25%] shadow-[0_0_80px_inset] shadow-primary/5"></div>
//                 </div>
//               </div>
//               {/* circles ends */}
...
//             Get Start
//           </LoginButton>
//           <RainbowButton>Import playlist</RainbowButton>
//         </div>
//       </div>
//     </section>
//   );
